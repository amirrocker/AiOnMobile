 ...
 */
package de.ams.techday.aionmobilemediapipe.objectdetection.gallery
...
import de.ams.techday.aionmobilemediapipe.objectdetection.camerax.getFittedBoxSize
...
fun ImageDetectionView(
    ...
    loadedImage?.copy(Bitmap.Config.ARGB_8888, true)?.let { image ->
        ...
        backgroundExecutor.execute {
            ...
            val objectDetectorHelper = ObjectDetectionHelper(
                context = context,
                threshold = threshold,
